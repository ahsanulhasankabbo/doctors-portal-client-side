...
const AddDoctor = () => {
    ...
    const { data: services, isLoading } = useQuery('services', () => fetch('https://evening-bayou-32468.herokuapp.com/service').then(res => res.json()))
    ...
    const onSubmit = async data => {
        ...
        .then(result => {
            if(result.success){
                ...
                fetch('https://evening-bayou-32468.herokuapp.com/doctor',{
                    method: 'POST',
                    headers: {
